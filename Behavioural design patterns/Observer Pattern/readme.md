...
public:
    void uploadVideo(string title) {
        ...
        cout << "Notify Email Subscribers" << endl;
    }
};
```
...
```cpp
void YoutubeChannel::uploadVideo(const string& videoTitle) {
...
public:
    void update(const string& videoTitle) override {
        cout << "Mobile notification: " << videoTitle << endl;
    }
};
```
...
public:
    void update(const string& videoTitle) override {
        cout << "Email notification: " << videoTitle << endl;
    }
};
```
