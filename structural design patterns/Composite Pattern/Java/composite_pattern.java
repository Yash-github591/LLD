...
interface CartItem{
  public void display(); // Function to display item details
  public double getPrice(); // Function to get item price 
}
...
class ProductBundle implements CartItem{
  ...
  private ArrayList<CartItem> items = new ArrayList<>(); // Collection of child components(items)
  
  // Constructor to initialize bundleName
...
public class Main{
  public static void main(String[] args){
    ...
    CartItem Laptop = new Item("Laptop", 999.99);
    CartItem Smartphone = new Item("Smartphone", 499.99);
    CartItem Headphones = new Item("Headphones", 199.99);
    CartItem Shampoo = new Item("Shampoo", 9.99);
    ...
    shoppingCart.add(Shampoo); // Add an individual item to the shopping cart
    shoppingCart.add(techBundle); // Add the tech bundle to the shopping cart
